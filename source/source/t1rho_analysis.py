...
class T1rhoAnalysis(curve.DecayAnalysis):
    r"""A class to analyze T1rho experiments.
    # section: see_also
    ...
    def _default_options(cls) -> Options:
        ...
        options.result_parameters = [curve.ParameterRepr("tau", "T1rho", "s")]
...
class T1KerneledAnalysis(curve.DecayAnalysis):
    r"""A class to analyze T1rho experiments with kerneled data.
    # section: see_also
        qiskit_experiments.curve_analysis.standard_analysis.decay.DecayAnalysis
    """
